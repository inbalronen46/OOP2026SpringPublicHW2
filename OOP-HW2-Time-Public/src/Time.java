...
public interface Time {
	...
	/**
	 * @return a short array contains the hour, the minute, and the second in this
	 *         order.
	 */
	public short[] getHMS();
	...
	/**
	 * @param hms
	 *            - an array contains the hour, the minute, and the second in this
	 *            order. update the time to represent the time in the parameter.
	 */
